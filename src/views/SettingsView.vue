...
<template>
  <div class="flex flex-col items-center justify-center min-h-[60vh] text-center p-6 space-y-4">
    ...
    <div class="space-y-1">
      <h2 class="text-xl font-bold text-slate-800 dark:text-slate-100">Settings & Taxonomies</h2>
      <p class="text-sm text-slate-500 dark:text-slate-400 max-w-xs">
        Configure Event Types, Subtypes, Taxonomies, Goals, Data Backup, and Appearance.
      </p>
    </div>
  </div>
</template>
