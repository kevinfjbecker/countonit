# 01: Project Setup & Base Navigation Shell

**What to build:** Initialize the Vue 3 + Vite + TypeScript + Tailwind CSS application structure with a mobile-first responsive layout container, a 4-tab bottom navigation bar (`Log`, `Dashboard`, `History`, `Settings`), and active view switching.
